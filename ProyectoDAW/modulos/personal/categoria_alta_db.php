    ...
    <script>
        $(document).ready(function () {
            ...
            $('#mensaje').dialog({
                ...
                buttons: {
                    "Agregar Otra Categoria": function () {
                        $("#mensaje").dialog("close");
                        location      = 'categoria_alta.php';
                    },
...
<body>
    <?php
        try {
            //Crear la consulta
            $sql = "INSERT INTO sakila.category (name) 
            VALUES ('$nombre')";
    ...
    ?>
            <script>
                $(document).ready(function () {
                    $("#mensaje").html("<h1>CATEGORIA AGREGADA CON EXITO</h1>");
                    $("#mensaje").dialog("open");    
                });
            </script>
    <?php
